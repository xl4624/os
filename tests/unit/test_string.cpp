...
TEST(string, strcpy_long_string) {
  ...
  ASSERT_STR_EQ(dest, "this is a very long string that tests the strcpy function");
}
...
TEST(string, strlen_empty) { ASSERT_EQ(strlen(""), 0); }

TEST(string, strlen_single_char) { ASSERT_EQ(strlen("a"), 1); }

TEST(string, strlen_with_spaces) { ASSERT_EQ(strlen("hello world"), 11); }
...
TEST(string, strnlen_larger_than_string) { ASSERT_EQ(strnlen("hi", 100), 2); }

TEST(string, strnlen_exact_length) { ASSERT_EQ(strnlen("hi", 2), 2); }

TEST(string, strnlen_zero_max) { ASSERT_EQ(strnlen("hello", 0), 0); }
...
TEST(string, strncmp_zero_length) { ASSERT_EQ(strncmp("abc", "def", 0), 0); }
...
TEST(string, strspn_all_match) { ASSERT_EQ(strspn("aaa", "a"), 3); }
...
TEST(string, strcspn_no_match) { ASSERT_EQ(strcspn("hello", "xyz"), 5); }

TEST(string, strcspn_immediate_match) { ASSERT_EQ(strcspn(",hello", ","), 0); }

TEST(string, strcspn_empty_string) { ASSERT_EQ(strcspn("", "abc"), 0); }
